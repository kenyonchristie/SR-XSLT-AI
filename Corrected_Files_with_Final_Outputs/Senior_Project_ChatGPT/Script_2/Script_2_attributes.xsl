...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:attribute-set name="graphic">
       <xsl:attribute name="content-width">6.5in</xsl:attribute><!--DEVELOPER INTERVENTION TO CHANGE WIDTH TO CONTENT-WIDTH-->
        <xsl:attribute name="content-height">3.5in</xsl:attribute><!--DEVELOPER INTERVENTION TO CHANGE HEIGHT TO CONTENT-HEIGHT-->
        <xsl:attribute name="text-align">center</xsl:attribute>
