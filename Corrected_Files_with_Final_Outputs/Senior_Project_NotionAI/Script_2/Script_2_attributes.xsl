...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:attribute-set name="page-size">
        <xsl:attribute name="page-width">8.5in</xsl:attribute><!--DEVELOPER INTERVENTION CORRECT ATTRIBUTES TO PAGE-WIDTH, PAGE-HEIGHT-->
    ...
    <!--DEVELOPER INTERVENTION TO ADD OMITTED BOX AND GRAPHIC SET-->
    ...
    <xsl:attribute-set name="title-2">
        <xsl:attribute name="font-family">Helvetica</xsl:attribute><!---DEVELOPER INTERVENTION CORR FONT TO HELVETICA-->
        <xsl:attribute name="font-weight">bold</xsl:attribute>
        <xsl:attribute name="font-size">16pt</xsl:attribute>
        <xsl:attribute name="keep-with-next">always</xsl:attribute>
        <xsl:attribute name="text-align">left</xsl:attribute>
        <xsl:attribute name="space-before">1.5pc</xsl:attribute>
        <!--<xsl:attribute name="space-after">1pc</xsl:attribute>--><!--DEVELOPER INTERVENTION RMV-->
    </xsl:attribute-set>
    ...
    <xsl:attribute-set name="graphic">
        <xsl:attribute name="text-align">center</xsl:attribute>
        <xsl:attribute name="content-width">6.5in</xsl:attribute><!--DEVELOPER INTERVENTION CORR ATTRIBUTES FOR WIDTH AND HEIGHT TO ADD CONTENT- PREFIX-->
        <xsl:attribute name="content-height">3.5in</xsl:attribute>
        <xsl:attribute name="alignment-adjust">central</xsl:attribute>
    </xsl:attribute-set>
    ...
    <xsl:attribute-set name="caption">
        ...
        <!--<xsl:attribute name="space-after">0.25pc</xsl:attribute>--><!--DEVELOPER INTERVENTION RMV-->
    </xsl:attribute-set>
